...
class CrmCustomerApiController extends Controller
{
    public function index()
    {
        ...
        return new CrmCustomerResource(CrmCustomer::with(['lead_source', 'market_segment', 'job_type', 'status'])->get());
    }
    ...
    public function show(CrmCustomer $crmCustomer)
    {
        ...
        return new CrmCustomerResource($crmCustomer->load(['lead_source', 'market_segment', 'job_type', 'status']));
    }
