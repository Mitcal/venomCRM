    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.job-types.update", [$jobType->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $jobType->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $jobType->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category_number') ? 'is-invalid' : '' }}" type="number" name="category_number" id="category_number" value="{{ old('category_number', $jobType->category_number) }}" step="1" required>
