					...
					<div id="fillin">
								...
								<div class="row">
									...
									<div class="col-md-5">
										...
										<label>{{ trans('cruds.crmCustomer.fields.first_name') }}</label>
											...
											<input type="text" pattern="[a-zA-Z0-9 \x27\x2d]+" class="form-control addRequiredClass" name="first_name" id="first_name" placeholder="*Firstname*"  value="{{ old('first_name', $crmCustomer->first_name) }}" required>
									...
									<div class="col-md-5">
										...
										<label>{{ trans('cruds.crmCustomer.fields.last_name') }}</label>
											...
											<input type="text" pattern="[a-zA-Z0-9 \x27\x2d]+" class="form-control addRequiredClass" name="last_name" id="last_name" placeholder="*Surname*" value="{{ old('last_name', $crmCustomer->last_name) }}" required>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<label>{{ trans('cruds.crmCustomer.fields.phone') }}</label>
											...
											<input type="text" class="form-control addReqClass" name="phone" id="phone" placeholder="*Phone*" value="{{ old('phone', $crmCustomer->phone) }}" required>
									...
									<div class="col-sm-6">
										...
										<label>{{ trans('cruds.crmCustomer.fields.email') }}</label>
											...
											<input type="email" class="form-control" name="email" id="email" placeholder="*Email*" value="{{ old('email', $crmCustomer->email) }}">
							...
							<legend>Location</legend>
								...
								<div class="row">
									...
									<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="postcodesearch" id="postcodesearch" value="{{ old('address_postcode', $crmCustomer->address_postcode) }}" required>
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<select class="form-control" name="address" id="addressSelection" required>
												...
												<option selected>{{ $crmCustomer->address }}</option>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<label>{{ trans('cruds.crmCustomer.fields.address_postcode') }}</label>
											...
											<input type="text" class="form-control" name="address_postcode" id="postcode"  value="{{ old('address_postcode', $crmCustomer->address_postcode) }}" required>
									...
									<div class="col-md-6">
										...
										<div class="form-group addReqClass">
												...
												<input class="form-control {{ $errors->has('hsnum') ? 'is-invalid' : '' }}" type="text" name="hsnum" id="hsnum" value="{{ old('hsnum', $crmCustomer->hsnum) }}" required>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<label>Address Road</label>
											...
											<input type="text" class="form-control" name="road" id="road" value="{{ old('road', $crmCustomer->road) }}" required>
									...
									<div class="col-md-6">
										...
										<div class="form-group addReqClass">
												...
												<input type="text" class="form-control" name="address_town" id="town" value="{{ old('address_town', $crmCustomer->address_town) }}" required>
										</div>
								...
								<label>{{ trans('cruds.crmCustomer.fields.address_country') }}</label>
									...
									<input type="text" class="form-control" name="address_country" id="address_country" value="{{ old('address_country', $crmCustomer->address_country) }}">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<label>Registration Search</label>
											...
											<input type="text" class="form-control" name="vehicle_reg" id="regSearch" placeholder="Reg Lookup" value="{{ old('vehicle_reg', $crmCustomer->vehicle_reg) }}" required>
								...
								<div class="row">
									...
									<div class="col-sm-3">
										...
										<label>{{ trans('cruds.crmCustomer.fields.vehicle_make') }}</label>
											...
											<input type="text" class="form-control addRequiredClass" name="vehicle_make" id="make" placeholder="*Make*" value="{{ old('vehicle_make', $crmCustomer->vehicle_make) }}" required>
									...
									<div class="col-sm-3">
										...
										<label>Vehicle Model</label>
											...
											<input type="text" class="form-control addRequiredClass" name="vehicle_model" id="model" placeholder="*Model*" value="{{ old('vehicle_model', $crmCustomer->vehicle_model) }}" required>
									...
									<div class="col-sm-3">
										...
										<label>Vehicle Age</label>
											...
											<input type="text" class="form-control addRequiredClass" name="vehicle_age" id="vehicle_age" placeholder="*Age*" value="{{ old('vehicle_age', $crmCustomer->vehicle_age) }}" required>
									...
									<div class="col-sm-3">
										...
										<label>Vehicle Colour</label>
											...
											<input type="text" class="form-control addRequiredClass" name="vehicle_colour" id="vehicleColour" placeholder="*Colour*" value="{{ old('vehicle_colour', $crmCustomer->vehicle_colour) }}"  required>
