<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('crm_field_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/crm-statuses*") ? "c-show" : "" }} {{ request()->is("admin/market-segments*") ? "c-show" : "" }} {{ request()->is("admin/lead-sources*") ? "c-show" : "" }} {{ request()->is("admin/job-types*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.crmField.title') }}
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('market_segment_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.market-segments.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/market-segments") || request()->is("admin/market-segments/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-chart-pie c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.marketSegment.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('lead_source_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.lead-sources.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/lead-sources") || request()->is("admin/lead-sources/*") ? "c-active" : "" }}">
                                <i class="fa-fw fab fa-red-river c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.leadSource.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('job_type_access')
